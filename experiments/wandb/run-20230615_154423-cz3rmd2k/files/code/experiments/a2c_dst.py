...
def parse_args():
    ...
    parser.add_argument("--aug", type=float, default=0.0001, help="The augmentation term in the utility function.")
    ...
    # Oracle arguments.
    parser.add_argument("--lrs", nargs='+', type=float, default=(0.00003, 0.00003),
