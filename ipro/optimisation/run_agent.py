...
def run_hp_search(exp_config, u_dir) -> Any:
...
def run_agents(exp_config: DictConfig, sweep_id: str, u_dir: str):
    """Run an agent for a sweep."""
    agent_fun = partial(run_hp_search, exp_config, u_dir)
    while True:
        wandb.agent(
            sweep_id,
            function=agent_fun,
...
if __name__ == "__main__":
    ...
    run_agents(exp_config, args.sweep_id, args.u_dir)
